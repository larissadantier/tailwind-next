      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col truncate">
            ...
            <span className="max-w-56 truncate text-sm text-red-600 dark:text-red-500">
              {name}
            </span>
          </div>
          ...
          <button
            type="button"
            className="text-sm font-semibold text-error-700 hover:text-error-900 dark:text-red-400 dark:hover:text-red-300"
          >
            Try Again
          </button>
        </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col truncate">
            <span className="max-w-56 truncate text-sm font-medium text-zinc-700 dark:text-zinc-100">
              {name}
            </span>
