export function LogoSVG() {
  return (
    <svg
      ...
      viewBox="0 0 38 38"
    >
      <g filter="url(#filter0_dd_22001_307)">
        <g clipPath="url(#clip0_22001_307)">
          ...
          <rect
            ...
            x="3"
            y="2"
            fill="url(#paint0_linear_22001_307)"
            rx="8"
          ></rect>
          <path
            fill="#D0D5DD"
          ...
          ></path>
          <g filter="url(#filter1_dd_22001_307)">
            <circle
              cx="19"
              cy="18"
              r="8"
              fill="url(#paint1_linear_22001_307)"
            ></circle>
          </g>
          <g filter="url(#filter2_b_22001_307)">
            <path
              fill="#fff"
              fillOpacity="0.2"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_22001_307"
          ></feBlend>
          <feColorMatrix
            in="SourceAlpha"
            result="hardAlpha"
          ...
          <feBlend
            in2="effect1_dropShadow_22001_307"
            result="effect2_dropShadow_22001_307"
          ></feBlend>
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_22001_307"
            result="shape"
          ></feBlend>
        </filter>
        <filter
          id="filter1_dd_22001_307"
          width="22"
          height="22"
          x="8"
          y="8"
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_22001_307"
          ></feComposite>
          <feBlend
            in="SourceGraphic"
            in2="effect1_backgroundBlur_22001_307"
            result="shape"
          ></feBlend>
        </filter>
        <linearGradient
          id="paint0_linear_22001_307"
          x1="19"
          x2="19"
          y1="2"
          y2="34"
